...
def create_sample_users(num_users: int = 5) -> None:
    ...
    for i in range(2):
        ...
        metadata = {
            ...
            "typing_experience": random.choice(["beginner", "intermediate", "advanced", "expert"]),
    ...
    print(f"   python scripts/pipeline/run_pipeline.py --version-id {version_id} --stages clean,keypairs,features,eda")
